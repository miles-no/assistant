...
export const getApiLocations = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<GetApiLocationsResponses, unknown, ThrowOnError>({
    url: '/api/locations',
    ...options,
  });
};
 ...
 */
export const postApiLocationsByIdManagers = <ThrowOnError extends boolean = false>(
 ...
 */
export const deleteApiLocationsByIdManagersByUserId = <ThrowOnError extends boolean = false>(
...
export const getApiRooms = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<GetApiRoomsResponses, unknown, ThrowOnError>({
    url: '/api/rooms',
    ...options,
  });
};
...
export const postApiRooms = <ThrowOnError extends boolean = false>(
  ...
  return (options.client ?? client).post<PostApiRoomsResponses, PostApiRoomsErrors, ThrowOnError>({
    security: [
      {
        scheme: 'bearer',
        type: 'http',
 ...
 */
export const getApiRoomsByIdAvailability = <ThrowOnError extends boolean = false>(
 ...
 */
export const getApiCalendarOfficeByLocationIdIcs = <ThrowOnError extends boolean = false>(
 ...
 */
export const getApiCalendarRoomByRoomIdIcs = <ThrowOnError extends boolean = false>(
 ...
 */
export const getApiCalendarUserByUserIdIcs = <ThrowOnError extends boolean = false>(
