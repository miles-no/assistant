...
import { Card, LoadingSpinner, Badge, Input } from '@/components/ui';
import { useLocations } from '@/hooks/useLocations';
import { MapPin, Building, Users, Search, Globe } from 'lucide-react';
    ...
    return (
      <Layout>
        <Card className="text-center">
          <p className="text-danger-600">Failed to load locations. Please try again.</p>
        </Card>
      </Layout>
    );
  }
      ...
      <div className="space-y-6">
        ...
        {filteredLocations.length === 0 ? (
          <Card className="text-center">
            ...
            <h3 className="mt-4 text-lg font-semibold text-gray-900">No locations found</h3>
            <p className="mt-2 text-gray-600">
            ...
            {filteredLocations.map((location) => (
              ...
              >
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  {location._count && location._count.rooms && location._count.rooms > 0 && (
                    <div className="flex items-center gap-2">
                ...
                {location.description && (
                  <div className="mt-4 border-t border-gray-100 pt-4">
                    <p className="line-clamp-2 text-sm text-gray-600">{location.description}</p>
                  </div>
                )}

                {/* Timezone */}
                <div className="mt-4 flex items-center justify-between border-t border-gray-100 pt-4">
                  <span className="text-xs text-gray-500">Timezone: {location.timezone}</span>
