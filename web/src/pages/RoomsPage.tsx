...
import { Card, Badge, Input, Button, LoadingSpinner } from '@/components/ui';
...
export default function RoomsPage() {
  ...
  const filteredRooms = useMemo(() => {
    ...
    return rooms.filter((room) => {
      ...
      const matchesCapacity = !minCapacity || (room.capacity && room.capacity >= parseInt(minCapacity));
    ...
    return (
      <Layout>
        <Card className="text-center">
          <p className="text-danger-600">Failed to load rooms. Please try again.</p>
        </Card>
      </Layout>
    );
  }
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-600">Find and book meeting spaces across all locations</p>
        </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <Badge variant={room.isActive ? 'success' : 'default'} size="sm" className="mt-1">
